---
title: vue踩坑之keep-alive缓存组件下better-scroll失效
date: 2018-05-22 23:45:38
categories: 
- web前端
tags: 
- vue
...
* 切换页面缓存后，better-scroll失效 ---- refresh
* swiper轮播组件在显示后，无法轮播 ---- observer： true  observeParents ： true
* 弹出层禁止滚动事件
* 缓存页面滚动位置一起变化
